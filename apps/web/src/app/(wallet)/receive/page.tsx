...
export default function ReceivePage() {
    ...
    const [addresses, setAddresses] = useState<Record<Chain, string | null>>({
        SOL: null,
        BTC: null,
        BNB: null,
    });
    ...
    return (
        <div className="max-w-lg mx-auto space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700/50 space-y-6">
                ...
                {loading && (
                    <div className="text-center text-slate-400 text-sm py-4">Cargando direcciones...</div>
                )}
                    ...
                    <>
                        ...
                        <div className="flex flex-col items-center gap-4">
                            {address ? (
                                ...
                                <div className="bg-slate-700/50 rounded-2xl p-8 text-center w-full">
                                    <p className="text-slate-400 text-sm">No tienes una dirección {selectedChain} generada aún.</p>
                                    <p className="text-slate-500 text-xs mt-1">Crea o importa tu wallet para generar esta dirección.</p>
                                </div>
                            )}
                        </div>
